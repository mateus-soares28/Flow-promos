...
ALTER TABLE `users` ADD `status` enum('pending_payment','active','suspended') DEFAULT 'active';--> statement-breakpoint
ALTER TABLE `users` ADD `stripeCustomerId` varchar(128);--> statement-breakpoint
ALTER TABLE `users` ADD `currentPlanId` varchar(64) DEFAULT 'pro_annual';--> statement-breakpoint
